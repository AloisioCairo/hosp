...
export default async (host = "localhost"): Promise<Connection> => {
    ...
    return createConnection(
        Object.assign(defaultOptions, {
            ...
            database: process.env.NODE_ENV === "test" ? "hosp_test" : "hosp", // Capítulo 4 > Testes e regras de negócio > Testes de integração > Criando o primeiro teste de integração
        })
    );
}
...
//     return createConnection( 
//         Object.assign(defaultOptions, {
//             database: process.env.NODE_ENV === "hosp" ? "hosp_test" : defaultOptions.database,
//         })
//     );
// }